...
<template>
  ...
  >
    ...
    <template #file="{ file }">
      <div style="width: 100%">
        <img class="el-upload-list__item-thumbnail" :src="getStaticResourceUrl(file.url)" />
  ...
  <el-image-viewer
    ...
    :url-list="modelValue.map((u) => getStaticResourceUrl(u))"
    @close="handlePreviewClose"
  />
</template>
<script setup lang="ts">
import { Plus, ZoomIn, Trash2 } from '@lucide/vue'
import { UploadRawFile, UploadRequestOptions, UploadUserFile } from 'element-plus'
import { getStaticResourceUrl } from '@/constants'
