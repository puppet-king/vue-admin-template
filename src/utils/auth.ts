...
export const AuthStorage = {
  getAccessToken(): string {
    ...
    return isRememberMe ? Storage.get(STORAGE_KEYS.ACCESS_TOKEN, '') : Storage.sessionGet(STORAGE_KEYS.ACCESS_TOKEN, '')
  },
 ...
 * 重定向到登录页面
 */
export async function redirectToLogin(message: string = '请重新登录', notify: boolean = true): Promise<void> {
