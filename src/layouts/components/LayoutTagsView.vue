<template>
  <div class="tags-container">
    <!-- 水平滚动容器 -->
    <el-scrollbar ref="scrollbarRef" class="scroll-container" :view-style="{ height: '100%' }" @wheel="handleScroll">
    ...
    <Teleport to="body">
      ...
      >
        ...
        <li @click="closeOtherTags">
          <el-icon><ChevronsRight /></el-icon>
          关闭其它
        </li>
        <li v-if="!isFirstView" @click="closeLeftTags">
          <el-icon><ChevronsLeft /></el-icon>
          关闭左侧
        </li>
...
import { RotateCw, X, ChevronsRight, ChevronsLeft } from '@lucide/vue'
