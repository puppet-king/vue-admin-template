  ...
  >
    <div class="settings-content">
      ...
      <section class="config-section">
        ...
        <div class="config-item flex justify-between">
        ...
        <div v-if="settingsStore.resolvedTheme !== ThemeMode.DARK" class="config-item flex justify-between">
      ...
      <section class="config-section">
        ...
        <div class="layout-select">
          <div class="layout-grid">
            <el-tooltip v-for="item in layoutOptions" :key="item.value" :content="item.label" placement="bottom">
              <div
                role="button"
                tabindex="0"
                :class="[
    ...
    <template #footer>
      <div class="action-buttons">
        <el-tooltip
          ...
          placement="top"
        >
          <el-button type="primary" size="default" :icon="copyIcon" :loading="copyLoading" @click="handleCopySettings">
...
import { Copy, RotateCcw, Check } from '@lucide/vue'
...
const resetIcon = markRaw(RotateCcw)
...
.layout-item {
  ...
  &:hover {
    background: linear-gradient(145deg, var(--el-bg-color) 0%, var(--el-color-primary-light-9) 100%);
  ...
  .layout-sidebar {
    ...
    left: 4px;
    width: 12px;
    background: linear-gradient(180deg, var(--el-color-primary-dark-2) 0%, var(--el-color-primary) 100%);
    border-radius: 2px;
  }
  ...
  &.is-active {
    background: linear-gradient(145deg, var(--el-color-primary-light-9) 0%, var(--el-color-primary-light-8) 100%);
